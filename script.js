document.addEventListener("DOMContentLoaded", () => {
    ...
    dropdowns.forEach(dropdown => {
        dropdown.addEventListener("click", function(e) {
            // Dropdown diubah dari <= 1250 menjadi <= 850 sesuai break poin mobile hamburger yang baru
    ...
    // --- 5. PTM MODAL LOGIC (Tetap dipertahankan agar Script aman dan tidak error) ---
